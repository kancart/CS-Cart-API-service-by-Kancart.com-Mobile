    ...
    public function execute() {
        ...
        if ($shippingAddressBookId) { //update address           
            ...
            if ($shippingAddressJson) {
                ...
                $shippingAddress = array_merge(prepare_address($addr, 'shipping'), prepare_address($addr, 'billing'));
            }
            ...
            $addr = array_merge(prepare_address($shippingAddress, 'shipping'), prepare_address($shippingAddress, 'billing'));  //the shipping address and the billing adress is the same
